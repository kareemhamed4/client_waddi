...
class CustomerServiceChatDetailsForDelegatesScreen extends StatefulWidget {
  const CustomerServiceChatDetailsForDelegatesScreen({Key? key}) : super(key: key);

  @override
  State<CustomerServiceChatDetailsForDelegatesScreen> createState() => _CustomerServiceChatDetailsForDelegatesScreenState();
}

class _CustomerServiceChatDetailsForDelegatesScreenState extends State<CustomerServiceChatDetailsForDelegatesScreen> {
  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (BuildContext context) {
        DriverLayoutCubit.get(context).getMessages(receiverId: "ekkODsmM09YBM8FggBbRw078Qfv1");
                      ...
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            if (cubit.delegateModelFB!.uId == message.senderId) {
